...
hl.animation({ leaf = "layersIn", enabled = true, speed = 3, bezier = "graceful", style = "slidevert" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 1.6, bezier = "vanish", style = "slidevert" })
